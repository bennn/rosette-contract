...
(provide
  ...
  (contract-out
    [automaton
     (-> state/c state/c payoff/c transition*/c automaton?)]
    [automaton?
     (-> any/c boolean?)]
    [automaton-current
     (-> automaton? state/c)]
    ...
    [make-random-automaton
     (-> natural-number/c automaton?)]
    [match-pair
     (-> automaton? automaton? natural-number/c (values automaton? automaton?))]
    [automaton-reset
     (-> automaton? automaton?)]
    [clone
     (-> automaton? automaton?)]
